"""
Django settings for collabnotes project.
...
WSGI_APPLICATION = 'collabnotes.wsgi.application'
...
ASGI_APPLICATION = 'collabnotes.asgi.application'
...
CACHES = {
    "default": {
        ...
        "LOCATION": "redis://127.0.0.1:6379/1",  # Using database 1 for cache (0 is default for Redis)
    }
}
